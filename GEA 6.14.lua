...
-- ==========================================================
-- Correction "Nom module" dans les conditions multiples
...
if (not GEA) then
  ...
  GEA.globalhisto       = nil
  GEA.runAt             = nil
  GEA.firmware          = tonumber(api.get("/settings/info").currentVersion.version)
  GEA.varenum           = tools.iif(GEA.firmware < 4.55, 0, false)
  GEA.suspendvar        = "SuspendreGEA"
  ...
  GEA.traduction = {
    en = {        
        ...
        device_is_missing   = "Device %s unknown",
        yes                 = "yes",
        no                  = "no",
    }, 
    fr = {
        ...
        device_is_missing   = "Device %s inconnu",
        yes                 = "oui",
        no                  = "non",
  ...
  GEA.options = {
    number    = {name="ID",
                    control=function(id) if (type(id) ~= "table") then id = {id} end local res, msg = true, "" for i=1, #id do if (not GEA.getName(GEA.findDeviceId(id[i]), GEA.showRoomNames)) then res = false msg = msg .. GEA.findDeviceId(id[i]) .. " " end end return res, string.format(GEA.trad.id_missing, msg) end,
                    getValue=function(id) return tonumber(fibaro:getValue(GEA.findDeviceId(id), "value")) end, 
                },
    ...
    value     = {name="Value", 
                    ...
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return fibaro:getValue(GEA.findDeviceId(id), "value") end, 
                    action=function(id, value) if (not value) then value = id id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"setValue",GEA.incdec(value, GEA.options.value.getValue(GEA.findDeviceId(id[i])))) end end
                },
    value2    = {name="Value2",
                    optimize = true,
                    math=true, -- autorise les Value+ et Value-
                    ...
                    action=function(id, value) if (not value) then value = id id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"setValue2",GEA.incdec(value, GEA.options.value2.getValue(GEA.findDeviceId(id[i])))) end end
                },
    property  = {name="Property", 
                    optimize = true,
                    math=true,
                    control=function(id) return GEA.options.number.control(id) end, 
                    getValue=function(id, property) return fibaro:getValue(GEA.findDeviceId(id), property) end,
                    action=function(id, property, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setProperty", property, GEA.getMessage(GEA.incdec(value, GEA.options.property.getValue(GEA.findDeviceId(id[i]), property)))) end end
                },
    turnon    = {name="TurnOn", 
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end, 
                    getValue=function(id) if (not id) then id = GEA.currentMainId end  return tonumber(fibaro:getValue(GEA.findDeviceId(id), "value"))>0 end, 
                    action=function(id, duree) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"turnOn") end if (duree) then setTimeout(function() for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"turnOff") end end, GEA.getDuree(duree) * 1000) end end
                },
    turnoff   = {name="TurnOff", 
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end, 
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return tonumber(fibaro:getValue(GEA.findDeviceId(id), "value"))==0 end, 
                    action=function(id, duree) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"turnOff") end if (duree) then setTimeout(function() for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"turnOn") end end, GEA.getDuree(duree) * 1000) end end
                },
    switch    = {name="Switch",
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end, 
                    action=function(id) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do if (tonumber(fibaro:getValue(GEA.findDeviceId(id[i]), "value"))>0) then fibaro:call(GEA.findDeviceId(id[i]),"turnOff") else fibaro:call(GEA.findDeviceId(id[i]),"turnOn") end end end
                },
    armed     = {name="Armed", 
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end,
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return tonumber(fibaro:getValue(GEA.findDeviceId(id), "armed"))==1 end, 
                },
    disarmed  = {name="Disarmed", 
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end,
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return tonumber(fibaro:getValue(GEA.findDeviceId(id), "armed"))==0 end, 
                },
    setarmed     = {name="Armed", 
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end,
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return tonumber(fibaro:getValue(GEA.findDeviceId(id), "armed"))==1 end, 
                    action=function(id) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"setArmed", 1) end end
                },
    setdisarmed  = {name="Disarmed",
                    optimize = true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end,
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return tonumber(fibaro:getValue(GEA.findDeviceId(id), "armed"))==0 end, 
                    action=function(id) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]),"setArmed", 0) end end
                },
    sensor    = {name="Sensor",
                    optimize = true,
                    math=true,
                    control=function(id) if (not id) then id = GEA.currentMainId end return GEA.options.number.control(id) end,
                    getValue=function(id) if (not id) then id = GEA.currentMainId end return fibaro:getValue(GEA.findDeviceId(id), GEA.power) end
                },
    virtualdevice = {name="VirtualDevice", 
                    optimize = true,
                    control=function(id, button) if (type(id) ~= "table") then id = {id} end for i=1, #id do local check, message = GEA.options.number.control(GEA.findButtonId(GEA.findDeviceId(id[i]), button)) if (check) then return tools.isNumber(GEA.findButtonId(GEA.findDeviceId(id[i]), button)), string.format(GEA.trad.not_number, button) else return check, message end end end,
                    action=function(id, button) if (type(id) ~= "table") then id = {id} end for i=1, #id do local currId = GEA.findDeviceId(id[i]) fibaro:call(currId, "pressButton", tostring(GEA.findButtonId(currId, button))) end end
                },
    label     = {name="Label",
                    optimize = true,
                    math=true,
                    ...
                    getValue=function(id, property) return fibaro:getValue(GEA.findDeviceId(id), "ui."..property:gsub("ui.", ""):gsub(".value", "")..".value") end, 
                    action=function(id, property, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setProperty", "ui."..property..".value", GEA.getMessage(GEA.incdec(value, GEA.options.label.getValue(GEA.findDeviceId(id[i]), property)))) end end
                },
    time      = {name="Time", 
    ...
    battery   = {name="Battery", 
                    ...
                    math=true,
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return fibaro:getValue(GEA.findDeviceId(id), 'batteryLevel') end
                },
    ...
    dead      = {name="Dead", 
                    optimize = true,
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return tonumber(fibaro:getValue(GEA.findDeviceId(id), "dead"))>0 end, 
                    action=function(id) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(1, "wakeUpAllDevices", GEA.findDeviceId(id[i])) end end
                },
    deads     = {name="Deads", 
                    optimize = true,
    ...
    sceneactivation = {name="SceneActivation", 
                    optimize = true,
                    getValue=function(id, value) return tonumber(fibaro:getValue(GEA.findDeviceId(id), "sceneActivation")) == tonumber(value) end
    ...
    currenticon= {name="CurrentIcon", 
                    optimize = true,
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return fibaro:getValue(GEA.findDeviceId(id), "currentIcon") end, 
                    action=function(id, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setProperty", "currentIcon", value) end end
                },
    scenario  = {name="Scenario", 
                    keepValues = true,
                    control=function(id) return type(fibaro:isSceneEnabled(GEA.findScenarioId(id))) ~= nil end,
                    action=function(id, args) if (type(id) ~= "table") then id = {id} end 
                      for i=1, #id do 
                        if (type(args) == "table") then
                          ...
                          --print("GetMessage : ", GEA.getMessage(arguments))
                          fibaro:startScene(GEA.findScenarioId(id[i]), args) 
                        else
                          fibaro:startScene(GEA.findScenarioId(id[i])) 
                        end
                      end 
                    end
                },
    killscenario  = {name="Kill", 
                    ...
                    action=function(id) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:killScenes(GEA.findScenarioId(id[i])) end end
                },
    picture   = {name="Picture", 
                    optimize = true,
                    keepValues = true,
                    action=function(id, destinataire) if (type(id) ~= "table") then id = {id} end if (type(destinataire) ~= "table") then destinataire = {destinataire} end for i=1, #id do for j =1, #destinataire do fibaro:call(GEA.findDeviceId(id[i]), "sendPhotoToUser", destinataire[j]) end end end
                },
    picturetoemail   = {name="PictureToEmail", 
                    optimize = true,
                    keepValues = true,
                    action=function(id, destinataire) if (type(id) ~= "table") then id = {id} end if (type(destinataire) ~= "table") then destinataire = {destinataire} end for i=1, #id do for j =1, #destinataire do fibaro:call(GEA.findDeviceId(id[i]), "sendPhotoToEmail", destinataire[j]) end end end
                },
    open      = {name="Open", 
                    optimize = true,
                    math=true,
                    depends = {"value"},
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return math.abs(-100+tonumber(GEA.options.value.getValue(GEA.findDeviceId(id)))) end,
                    action=function(id, value) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end  if (not value) then value = 100 end for i=1, #id do GEA.options.value.action(GEA.findDeviceId(id[i]), value) end  end
                },
    close     = {name="Close",
                    optimize = true,
                    math=true,
                    depends = {"value"},
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return GEA.options.value.getValue(GEA.findDeviceId(id)) end,
                    action=function(id, value) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end  if (not value) then value = 100 end for i=1, #id do GEA.options.value.action(GEA.findDeviceId(id[i]), math.abs(-100+value)) end end
                },
    stop      = {name="Stop", 
                    optimize = true,
                    control=function(id) return GEA.options.number.control(id) end,
                    action=function(id) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "stop") end end
                },
    ...
    program   = {name="Program", 
                    optimize = true,
                    math=true,
                    getValue=function(id) return fibaro:getValue(GEA.findDeviceId(id), "currentProgram") end, 
                    action=function(id, prog) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "startProgram", prog) end end
                },
    thermostatlevel   = {name="ThermostatLevel", 
                    optimize = true,
                    control=function(id) return GEA.options.number.control(id) end,
                    getValue=function(id) return fibaro:getValue(GEA.findDeviceId(id), "value") end, --targetLevel
                    action=function(id, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setTargetLevel", tostring(GEA.incdec(value, GEA.options.thermostatlevel.getValue(GEA.findDeviceId(id[i]))))) end end
                },
    thermostattime   = {name="ThermostatTime", 
                    optimize = true,
                    control=function(id) return GEA.options.thermostatlevel.control(id) end,
                    getValue=function(id) return fibaro:getValue(GEA.findDeviceId(id), "timestamp") end,
                    action=function(id, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setTime", tonumber(os.time()) + value) end end
                },                
    ask       = {name="Ask",
                    optimize = true,
    ...
    sleep      = {name="Sleep", 
                    ...
                    keepValues = true,
                    action=function(duree, option) local o = GEA.getOption(option) if (duree and o) then setTimeout(function() GEA.currentAction.name = o.name o.action(true) end, GEA.getDuree(duree)*1000) end end
                },
    variablecache = {name="VariableCache",
                    optimize = true,
                    math=true,
                    control=function() return GEA.currentEntry.getDuration() >= 0, GEA.trad.varCacheInstant end,
    ...
    enablescenario = {name="EnableScenario",
                    optimize = true,
                    control=function(id) return GEA.options.scenario.control(id) end,
                    getValue=function(id) return fibaro:isSceneEnabled(GEA.findScenarioId(id)) end, 
                    action=function(id) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:setSceneEnabled(GEA.findScenarioId(id[i]), true) end end
                },
    disablescenario = {name="DisableScenario",
                    optimize = true,
                    control=function(id) return GEA.options.scenario.control(id) end,
                    getValue=function(id) return not fibaro:isSceneEnabled(GEA.findScenarioId(id)) end, 
                    action=function(id) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:setSceneEnabled(GEA.findScenarioId(id[i]), false) end end
                },      
    setrunconfigscenario = {name="SetrunConfigScenario", 
                    optimize = true,
                    control=function(id) return GEA.options.scenario.control(id) end,
                    getValue=function(id) return fibaro:getSceneRunConfig(GEA.findScenarioId(id)) end,
                    action=function(id, runconfig) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:setSceneRunConfig(GEA.findScenarioId(id[i]), runconfig) end end
                },          
    countscenes = {name="CountScenes",
                    optimize = true,
                    control=function(id) return GEA.options.scenario.control(id) end,
                    getValue=function(id) return fibaro:countScenes(GEA.findScenarioId(id)) end
                },                    
    popup       = {name="Popup",
                    optimize = true,
    ...
    rgb         = {name="RGB",
                    optimize = true,
                    control=function(id) return GEA.options.number.control(id) end,
                    action=function(id, r, g, b, w) if (type(id) ~= "table") then id = {id} end for i=1, #id do fibaro:call(GEA.findDeviceId(id[i]), "setColor", r or 0, g or 0, b or 0, w or 0) end end
                },
    centralsceneevent = {name="CentralSceneEvent",
                    optimize = true,
                    control=function(id, key, attribute) 
                      if (GEA.currentEntry.getDuration() > -1) then return false, GEA.trad.central_instant end
    ...
    alarm     = {name = "Alarm", 
                    ...
                    getValue=function(id)                       
                      if (os.date("%H:%M", GEA.runAt) == fibaro:getValue(GEA.findDeviceId(id), "ui.lblAlarme.value")) then
                        local days = fibaro:getValue(GEA.findDeviceId(id), "ui.lblJours.value")
                        days = days:lower()
    ...
    pluginscenario = {name="PluginScenario",
                  ...
                  getValue=function(...) 
                    ...
                    return GEA.waitWithTimeout(function() 
                        ...
                        if (vgplugins and vgplugins ~= "" and vgplugins ~= "NaN") then GEA.plugins = json.decode(vgplugins) end
    ...
    doorlock     = {name="DoorLock", 
                    ...
                    action=function(id, value) if (not id) then id = GEA.currentMainId end if (type(id) ~= "table") then id = {id} end for i=1, #id do if value == tools.tostring("secure") then fibaro:call(GEA.findDeviceId(id[i]),"secure") else fibaro:call(GEA.findDeviceId(id[i]),"unsecure") end end end
                },  
    o_r     = {name="Or", 
                    optimize = true,
                    keepValues = true,
    ...
    hue     = {name="Hue", 
                    ...
                    math = true,
                    control=function(id) return GEA.options.number.control(id) end, 
                    getValue=function(id, property) if (not id) then id = GEA.currentMainId end return fibaro:getValue(GEA.findDeviceId(id), property) end, 
                    getHubParam=function(id)
                      local device = api.get("/devices/"..GEA.findDeviceId(id))
                    ...
                    action=function(id, property, value) if (type(id) ~= "table") then id = {id} end for i=1, #id do 
                      local lightid, ip, username = GEA.options.hue.getHubParam(GEA.findDeviceId(id[i]))
      ...
      sectionlights = {name="SectionLights",
        ...
        result  = { name = "Result", math = true, getValue=function(position) if (not position) then position = 1 end return GEA.currentEntry.conditions[position].lastDisplayValue end },
        ...
        trigger = { name = "Trigger", 
                    getValue=function() 
                      ...
                      elseif (GEA.source.type == "property") then 
                        if (GEA.source.propertyName) then 
                          return "Property[" ..GEA.source.deviceID .." - " .. GEA.source.propertyName .. "]"
                        end
        ...
        sonosmp3 = {name = "Sonos MP3",
                    action = function(vd_id, button_id, filepath, volume)
                      ...
                      _x:set(tostring(GEA.findDeviceId(vd_id)), { stream = {stream=filepath, source="local", duration="auto", volume=volume} })
                      _f:call(GEA.findDeviceId(vd_id), "pressButton", button_id)
                    end,
                  },
        sonostts = {name = "Sonos TTS",
                    action = function(vd_id, button_id, message, volume)
                      ...
                      local _f = fibaro
                      local _x ={root="x_sonos_object",load=function(b)local c=_f:getGlobalValue(b.root)if string.len(c)>0 then local d=json.decode(c)if d and type(d)=="table"then return d else _f:debug("Unable to process data, check variable")end else _f:debug("No data found!")end end,set=function(b,e,d)local f=b:load()if f[e]then for g,h in pairs(d)do f[e][g]=h end else f[e]=d end;_f:setGlobal(b.root,json.encode(f))end,get=function(b,e)local f=b:load()if f and type(f)=="table"then for g,h in pairs(f)do if tostring(g)==tostring(e or"")then return h end end end;return nil end}
                      _x:set(tostring(GEA.findDeviceId(vd_id)), { tts = {message=message, duration='auto', language=GEA.trad.locale, volume=volume} })
                      _f:call(GEA.findDeviceId(vd_id), "pressButton", button_id)
                    end,
                  },
        ...
        slider    = {name="Slider",
                    ...
                    action=function(id, property, value) 
                      if (type(id) ~= "table") then id = {id} end 
                      for i=1, #id do 
                        property = GEA.findButtonId(GEA.findDeviceId(id[i]), property)
    ...
    checklabel   = {name="CheckLabel",
                getValue=function(id, name)
                  ...
                  if (not GEA.vdlist[GEA.findDeviceId(id)]) then return false, string.format(GEA.trad.id_missing, GEA.findDeviceId(id)) end
                  local result = GEA.vdlist[GEA.findDeviceId(id)][name:gsub("ui.", ""):gsub(".value", "")] or false
                  return result
                end,
              },
    protection = {name="Protection",
                    ...
                    depends= {"property"},
                    getValue=function(id) 
                      local loc = tonumber(fibaro:getValue(GEA.findDeviceId(id), "localProtectionState")) > 0
                      local rf = tonumber(fibaro:getValue(GEA.findDeviceId(id), "RFProtectionState")) > 0
                      local result = "off"
                    ...
                    action=function(id,typeprotection,mode) 
                        ...
                        for i=1, #id do 
                            fibaro:call(GEA.findDeviceId(id[i]), "setProtection", arg1, arg2)                             
                        end 
                      end
                    },   
    multialarm     = {name = "multiAlarm", 
                    -- par drboss
                    optimize = true,
                    control=function(id, label) 
                      local res, msg = GEA.options.label.control(id, label.."j")
                      if (msg) then msg = msg:gsub(label.."j", label) end
                      return res, msg
                    end,
                    getValue=function(id, multi_a)
                      if (os.date("%H:%M", GEA.runAt) == fibaro:getValue(GEA.findDeviceId(id), "ui."..multi_a.."h.value")) then
                        local days = fibaro:getValue(GEA.findDeviceId(id), "ui."..multi_a.."j.value")
                        days = days:lower()
                        selected = tools.split(days, " ")
                        for i = 1, #selected do
                          for j = 1, #GEA.trad.week_short do
      ...
      setmode = {name = "setMode", 
                optimize = true,
                control=function(id) return GEA.options.number.control(id) end,
                action=function(id, mode) return fibaro:call(GEA.findDeviceId(id), "setMode", mode) end,
                },
      setthermostatsetpoint = {name = "setThermostatSetpoint", 
                optimize = true,
                control=function(id) return GEA.options.number.control(id) end,
                action=function(id, mode, value) return fibaro:call(GEA.findDeviceId(id), "setThermostatSetpoint", mode, value) end,
                },
      stringtoalpha  = {name="StringToAlpha", --- by MAM78
  ...
  GEA.options.notstarted = GEA.copyOption("notstart")

  -- ----------------------------------------------------------
  -- Retourne l'ID d'un scénario selon son nom
  -- ----------------------------------------------------------
  GEA.findScenarioId = function(scenarioId)
    if (tonumber(scenarioId)) then 
      ...
      if (sceneId) then 
        ...
        tools.error(string.format(GEA.trad.device_is_missing, scenarioId))
        fibaro:abort()
      end
    end    
  end
  
  GEA.getDuree = function(valeur) 
    if (tonumber(valeur)) then 
       return tonumber(valeur) 
    else
      local duree = fibaro:getGlobalValue(valeur)
  ...
  -- ----------------------------------------------------------
  GEA.findDeviceId = function(deviceId, silent)
    if (tonumber(deviceId)) then 
      return tonumber(deviceId) 
    elseif (type(deviceId) ~= "string") then
      return deviceId
    else
      if (GEA.nameToId[deviceId]) then
        return GEA.nameToId[deviceId]
      end
      ...
      if (#devices>0) then 
        GEA.nameToId[deviceId] = devices[1].id
        return devices[1].id 
      else  
        if (silent) then
          return deviceId
        end
        tools.error(string.format(GEA.trad.device_is_missing, deviceId))
        fibaro:abort()
      end
    end
  end
  ...
  -- ----------------------------------------------------------
  GEA.findButtonId = function(deviceId, buttonId) 
    if (tonumber(buttonId)) then 
      return tonumber(buttonId) 
    else
      if (not GEA.buttonIds[deviceId .. " - " .. buttonId]) then
        ...
        for i = 1, #device.properties.rows do
          if (device.properties.rows[i].type == "button") then
            for j = 1, #device.properties.rows[i].elements do
              if (GEA.compareString(device.properties.rows[i].elements[j].name, buttonId) or GEA.compareString(device.properties.rows[i].elements[j].caption, buttonId)) then
                GEA.buttonIds[deviceId .. " - " .. buttonId] = device.properties.rows[i].elements[j].id
                return GEA.buttonIds[deviceId .. " - " .. buttonId]
              end
            end
          end
        end
  ...
  GEA.getNameInCache = function(id)
    local id_num = GEA.findDeviceId(id)
    if (type(id_num) == "number") then 
      id = tonumber(id_num) 
      if (not GEA.moduleNames[id_num]) then 
        GEA.moduleNames[id_num] = fibaro:getName(id_num)
      end 
      return GEA.moduleNames[id_num] or GEA.trad.name_is_missing
    else 
      return "" 
    end
  end
  ...
  GEA.getRoomInCache = function(id)
    ...
    if (type(id_num) == "number") then 
      id = tonumber(id_num) 
      if (not GEA.moduleRooms[id_num]) then 
        local idRoom = api.get("/devices/"..id_num)
        if (idRoom) then idRoom = idRoom.roomID end
        if (idRoom and idRoom > 0) then 
          GEA.moduleRooms[id_num] = fibaro:getRoomName(idRoom)
        end
      end
      return GEA.moduleRooms[id_num] or GEA.trad.room_is_missing
    else 
      return "" 
    end
  end
  ...
  GEA.getOption = function(object, silent)
    ...
    local option = nil
    if (tonumber(sname) or tonumber(GEA.findDeviceId(sname, true))) then tname = "number" object = tonumber(GEA.findDeviceId(sname, true)) end
  ...
  GEA.encapsule = function(option, args, inverse, plus, moins, option_id, not_immediat)
    ...
    copy.name = GEA.findDeviceId(option.name, true)
    ...
    copy.getId = function()  
                    ...
                    elseif (GEA.plugins[copy.name]) then 
                      ...
                      if (copy.args[1]) then return GEA.findDeviceId(copy.args[1], true) end
                      return nil
                    end
      end
    ...
    copy.getValue = function() 
                        ...
                        elseif (type(copy.name)=="boolean") then 
                          copy.lastvalue, copy.lastDisplayValue = GEA.options.boolean.getValue(copy.name)
                        elseif (type(copy.name)=="number") then 
                          copy.lastvalue, copy.lastDisplayValue = GEA.options.number.getValue(copy.name) 
                        else 
  ...
  GEA.flatTime = function(time, force)
    ...
    if (force) then
      if (GEA.currentEntry.firstvalid) then
        ...
        sun = sun + GEA.currentEntry.getDuration()
        t = os.date("*t", sun)	
  ...
  GEA.checkDates = function(from, to)
    ...
    if (not y) then to = to .. GEA.trad.input_date_format:match("[/,.]") .. os.date("%Y", GEA.runAt) missingYear = true end
  ...
  GEA.add = function(c, d, m, a, l)
    ...
    entry.getDuration = function() 
      return GEA.getDuree(entry.duration)
    end
    ...
    if (type(c) == "table" and ( type(c[1]) == "table" or type(GEA.findDeviceId(c[1], true)) == "number" or c[1]:find("%d+!") or type(c[1]) == "boolean")) then
      for i = 1, #c do 
    ...
    if (GEA.event and GEA.event.id) then
      ...
      for i = 1, #entry.conditions do
        ...
        if (type(ids) == "table") then
          for j = 1, #ids do
            if (tostring(ids[j]) == tostring(GEA.event.id) and not GEA.event.label) then found = true end
            if (tostring(ids[j]) == tostring(GEA.event.id) and GEA.event.label) then 
              if ("ui."..entry.conditions[i].args[2]:gsub("ui.", ""):gsub(".value", "")..".value" == GEA.event.label) then
                found = true 
              end
            end
          end
        else
          if (tostring(ids) == tostring(GEA.event.id) and not GEA.event.label) then found = true end
          if (tostring(ids) == tostring(GEA.event.id) and GEA.event.label) then 
            if ("ui."..entry.conditions[i].args[2]:gsub("ui.", ""):gsub(".value", "")..".value" == GEA.event.label) then
              found = true 
            end
          end         
    ...
    if (correct) then 
      ...
      tools.error(tools.iif(entry.getDuration() < 0, GEA.trad.add_event .." ", GEA.trad.add_auto .." ") .. entry.log) 
      tools.error(erreur) 
  ...
  GEA.check = function(entry) 
    ...
    if (ready) then
      ...
      if (os.difftime(GEA.runAt, entry.lastvalid) >= entry.getDuration()) then
        ...
        for i = 1, #entry.actions do
          GEA.currentAction = entry.actions[i]
          tools.debug("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;["..GEA.trad.action.."] " .. GEA.getMessage(entry.actions[i].getLog(), nil, true))
  ...
  -- ----------------------------------------------------------
    GEA.getMessage = function(message, forAnalyse, forLog)
    ...
    message:gsub("({.-})", function(c) 
        if (forLog) then
          ...
          local res, mess = GEA.getOption(d).getValue()
      ...
      if (scenes[i].isLua) then
        ...
        if (string.match(scene.lua, "GEAPlugin%.version.?=.?(%d+)")) then
          ...
          if (tools.isNil(GEA.getGlobalValue(GEA.pluginsvariables))) then 
            ...
            api.post("/globalVariables", {name=GEA.pluginsvariables, isEnum=GEA.varenum}) 
          end
  ...
  GEA.run = function() 
    GEA.running = string.lower(fibaro:getGlobalValue(GEA.suspendvar)) ~= GEA.trad.yes -- fibaro:isSceneEnabled(__fibaroSceneId)
    if (GEA.running) then
      GEA.runAt = os.time()
      GEA.forceRefreshValues = false
      ...
      tools.log("GEA suspendu/ed (variable : "..GEA.suspendvar .. ") ...", "orange", true)
    end
  end
  ...
  GEA.init = function()
    ...
    if (not GEA.auto) then
      ...
      if (GEA.source.type == "global") then
        GEA.event.id = GEA.source.name
      elseif (GEA.source.type == "property") then 
        GEA.event.id = GEA.source.deviceID
        if (GEA.source.propertyName and GEA.source.propertyName:find("ui.")) then 
          GEA.event.label = GEA.source.propertyName
        end
      elseif (GEA.source.type == "event") then
        GEA.event.id = GEA.source.event.data.deviceId
      ...
      if (GEA.source.type ~= "other") then tools.info(string.format(GEA.trad.gea_start_event, GEA.version, GEA.source.type, GEA.event.id), "cyan") end
    end
    GEA.searchPlugins()
    ...
    if (GEA.auto) then 
      ...
      tools.info("--------------------------------------------------------------------------------")
      if (tools.isNil(GEA.getGlobalValue(GEA.globalvariables))) then api.post("/globalVariables", {name=GEA.globalvariables, isEnum=GEA.varenum}) end
      if (tools.isNil(GEA.getGlobalValue(GEA.historyvariable))) then api.post("/globalVariables", {name=GEA.historyvariable, isEnum=GEA.varenum}) end
      if (tools.isNil(GEA.getGlobalValue(GEA.suspendvar))) then api.post("/globalVariables", {name=GEA.suspendvar, isEnum=GEA.varenum}) end
      fibaro:setGlobal(GEA.globalvariables, "") 
      fibaro:setGlobal(GEA.historyvariable, "")
      fibaro:setGlobal(GEA.suspendvar, GEA.trad.no) 
